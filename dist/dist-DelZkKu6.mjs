...
import { a as validateColorGradingContract, l as readClipTiming, o as COMPOSITION_ATTRIBUTES$1, t as postcss_default } from "./postcss-C5T55kSm.mjs";
...
async function loadParseGsapScript() {
	return (await import("./gsapParserAcorn-DcZJ6iA4.mjs")).parseGsapScriptAcorn;
}
async function loadGsapScriptMotionPathFirstUseIndex() {
	return (await import("./gsapParserAcorn-DcZJ6iA4.mjs")).gsapScriptMotionPathFirstUseIndex;
}
