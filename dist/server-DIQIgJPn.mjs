import { O as createOutputItemSchema, a as TOKENS, b as MultiOutputGenericSchema, c as logger, k as createVirtualMedia, w as VirtualMediaDataSchema } from "./dist-CJI3Jl43.mjs";
import { a as defineMetadata, i as defineNode } from "./server-ClH_dFot.mjs";
import path from "node:path";
import { z as z$1 } from "zod";
import { inject, injectable } from "inversify";

//#region ../../nodes/node-html-video-render/dist/metadata-DIv9BFMI.mjs
...
let HtmlVideoRenderProcessor = class HtmlVideoRenderProcessor$1 {
	...
	async process({ node, data }) {
		try {
			...
			const renderResult = await this.mediaRenderer.renderHtmlVideo(htmlContent, { userId: data.canvas.userId });
			let asset;
