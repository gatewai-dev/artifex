import { k as createVirtualMedia } from "./dist-Bbhn-cb5.mjs";
...
//#region ../../nodes/node-noise-generator/dist/metadata-CHrVZMx_.mjs
...
}).field("colorStart", z$1.string().regex(/^#[0-9a-fA-F]{6}$/).default("#000000"), {
	bindable: false,
	label: "Color Start"
}).field("colorEnd", z$1.string().regex(/^#[0-9a-fA-F]{6}$/).default("#ffffff"), {
	bindable: false,
	label: "Color End"
