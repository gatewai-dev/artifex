...
//#region ../../nodes/node-channel-splitter/dist/renderer.mjs
...
const ChannelSplitterWebGPURenderer = async (args) => {
...
var renderers_default = defineRenderer({ WebGPURenderer: ChannelSplitterWebGPURenderer });
