import { N as getActiveMediaMetadata, a as TOKENS, k as createVirtualMedia, m as DEFAULT_DURATION_MS, p as BaseVideoLayerPropsSchema, r as GetAssetEndpointBackend, v as MediaMetadataSchema, w as VirtualMediaDataSchema } from "./dist-Bbhn-cb5.mjs";
import "./dist-BJT_v1BL.mjs";
import "./dist-DUKtYY2w.mjs";
import { a as defineMetadata, i as defineNode } from "./server-RmKl3RaO.mjs";
import { n as resolveLayerDuration } from "./layer-logic-BRnbLDhA-CBNvQ4ED.mjs";
import { c as VideoResultSchema, i as ImageResultSchema, n as BaseLayerSchema, r as ColorSchema } from "./dist-C-mYL7qe.mjs";
import { z as z$1 } from "zod";
import { inject, injectable } from "inversify";

//#region ../../nodes/node-compositor/dist/metadata-hMVeTS71.mjs
...
const CompositorLayerSchema = BaseLayerSchema.merge(BaseVideoLayerPropsSchema.omit({ speed: true })).extend({
	...
	volume: z$1.number().min(0).max(1).optional(),
	...
	transition: z$1.object({
		...
		durationInMS: z$1.number().int().min(1)
	}).optional(),
...
const CompositorNodeConfigSchema = z$1.object({
	...
	volume: z$1.number().min(0).max(1).optional(),
	FPS: z$1.number().int().min(1).max(120).default(24).optional()
