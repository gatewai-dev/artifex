...
//#endregion
//#region ../../node_modules/.pnpm/postcss@8.5.9/node_modules/postcss/lib/terminal-highlight.js
...
var require_util = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	var normalize = lruMemoize(function normalize(aPath) {
		...
		var isAbsolute$2 = exports.isAbsolute(path);
		var parts = [];
		var start = 0;
		var i = 0;
		while (true) {
...
var require_previous_map = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	let { existsSync: existsSync$1, readFileSync: readFileSync$1 } = __require("fs");
	let { dirname: dirname$2, join: join$1 } = __require("path");
...
var require_rule = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var Rule = class extends Container {
		...
		set selectors(values) {
			...
			let sep$2 = match ? match[0] : "," + this.raw("between", "beforeOpen");
			this.selector = values.join(sep$2);
		}
		constructor(defaults) {
			super(defaults);
			this.type = "rule";
...
//#endregion
//#region ../../node_modules/.pnpm/postcss@8.5.9/node_modules/postcss/lib/postcss.js
