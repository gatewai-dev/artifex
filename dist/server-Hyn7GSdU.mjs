import { M as generateId, O as createOutputItemSchema, a as TOKENS, b as MultiOutputGenericSchema, c as logger, k as createVirtualMedia, s as getAssetKey, w as VirtualMediaDataSchema } from "./dist-Bbhn-cb5.mjs";
...
//#region ../../nodes/node-lottie/dist/metadata-CFPjLm63.mjs
...
const LottieNodeConfigSchema = z$1.object({
	model: z$1.enum(LOTTIE_NODE_MODELS).default("gpt-5.6-terra"),
	width: z$1.number().int().min(16).max(4096).default(512),
	height: z$1.number().int().min(16).max(4096).default(512),
	fps: z$1.number().int().min(12).max(60).default(24),
