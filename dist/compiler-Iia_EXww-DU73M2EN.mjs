...
import { i as resolveLayerDuration } from "./dist-DQgw6Nnp.mjs";
...
function buildYogaNode(yoga, node, parentExtent, measure, parentDir) {
	...
	if (isContainer) {
	...
	} else if (node.kind === "text") yn.setMeasureFunc((width, widthMode, height, heightMode) => {
		let constraintWidth;
		...
		if (measured) {
			...
			if (node.kind === "media" && !hasRatio) yn.setAspectRatio(intrinsicRatio);
