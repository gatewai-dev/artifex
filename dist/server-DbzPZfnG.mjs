...
//#region ../../nodes/node-svg/dist/metadata-CEww7Nuc.mjs
...
const SvgNodeConfigSchema = z$1.object({
	...
	colors: z$1.array(z$1.string().regex(/^#[0-9a-fA-F]{6}$/, "must be a 6-digit hex color")).max(10).default([]),
	backgroundColor: z$1.string().regex(/^#[0-9a-fA-F]{6}$/, "must be a 6-digit hex color").nullable().default(null)
}).strict();
