import { C as VirtualMediaDataSchema, D as createOutputItemSchema, M as getActiveMediaMetadata, T as appendOperation, a as TOKENS, y as MultiOutputGenericSchema } from "./dist-Cb5n7sba.mjs";
import { a as defineMetadata, i as defineNode } from "./server-CvuBrF2w.mjs";
import { z as z$1 } from "zod";
import { inject, injectable } from "inversify";

//#region ../../nodes/node-resizer-scaler/dist/metadata-e5iscu3A.mjs
const ResizerScalerNodeConfigSchema = z$1.object({
	...
	backgroundColor: z$1.string().regex(/^#(?:[0-9a-fA-F]{3}|[0-9a-fA-F]{4}|[0-9a-fA-F]{6}|[0-9a-fA-F]{8})$/, "must be a valid hex color starting with #").default("#000000FF"),
	backgroundColor2: z$1.string().regex(/^#(?:[0-9a-fA-F]{3}|[0-9a-fA-F]{4}|[0-9a-fA-F]{6}|[0-9a-fA-F]{8})$/, "must be a valid hex color starting with #").default("#000000FF"),
