import { E as appendOperation, N as getActiveMediaMetadata, O as createOutputItemSchema, a as TOKENS, b as MultiOutputGenericSchema, w as VirtualMediaDataSchema } from "./dist-D86uNdKf.mjs";
import { a as defineMetadata, i as defineNode } from "./server-BdNfjggX.mjs";
import { z as z$1 } from "zod";
import { inject, injectable } from "inversify";

//#region ../../nodes/node-resizer-scaler/dist/metadata-BFefbG8A.mjs
const ResizerScalerNodeConfigSchema = z$1.object({
	...
	zoom: z$1.number().min(1).max(1e3).default(100),
	offsetX: z$1.number().default(0),
	offsetY: z$1.number().default(0),
	...
	blurRadius: z$1.number().min(0).max(100).default(40),
