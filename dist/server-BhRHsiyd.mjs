import { M as generateId, O as createOutputItemSchema, _ as FileDataSchema, a as TOKENS, b as MultiOutputGenericSchema, c as logger, k as createVirtualMedia } from "./dist-CQCeP0r0.mjs";
...
//#region ../../nodes/node-text-to-speech/dist/metadata-Dfam-3YR.mjs
...
const TextToSpeechNodeConfigSchema = z$1.object({
	...
	temperature: z$1.number().default(1).describe("Controls the randomness of the speech output"),
	...
	speakerConfig: z$1.array(z$1.object({
		speaker: z$1.string().optional().describe("Alias used to identify this speaker in the prompt (alphanumeric, no whitespace)"),
