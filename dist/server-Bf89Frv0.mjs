import { C as SingleOutputGenericSchema, E as appendOperation, N as getActiveMediaMetadata, O as createOutputItemSchema, a as TOKENS, w as VirtualMediaDataSchema } from "./dist-D86uNdKf.mjs";
import { a as defineMetadata, i as defineNode } from "./server-BdNfjggX.mjs";
import { z as z$1 } from "zod";
import { inject, injectable } from "inversify";

//#region ../../nodes/node-extract-frame/dist/metadata-hM39grxJ.mjs
const ExtractFrameConfigSchema = z$1.object({ frame: z$1.number().min(0).default(0) }).strict();
