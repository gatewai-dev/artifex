...
import { c as VideoResultSchema, i as ImageResultSchema } from "./dist-xdozats3.mjs";
import { z as z$1 } from "zod";
import { inject, injectable } from "inversify";

//#region ../../nodes/node-levels/dist/metadata-BJpkhwJA.mjs
const LevelChannelSchema = z$1.object({
	...
	if (val.inBlack >= val.inWhite) ctx.addIssue({
		code: z$1.ZodIssueCode.custom,
		path: ["inWhite"],
		message: "inWhite must be greater than inBlack"
	});
	if (val.outBlack >= val.outWhite) ctx.addIssue({
		code: z$1.ZodIssueCode.custom,
		path: ["outWhite"],
