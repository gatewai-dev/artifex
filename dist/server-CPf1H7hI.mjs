import { O as createOutputItemSchema, b as MultiOutputGenericSchema, k as createVirtualMedia, w as VirtualMediaDataSchema } from "./dist-vHBVmGr1.mjs";
import { a as defineMetadata, i as defineNode } from "./server-CREtBW5m.mjs";
import { z as z$1 } from "zod";
import { injectable } from "inversify";

//#region ../../nodes/node-canvas-generator/dist/metadata-g9mmbdcY.mjs
const CanvasGeneratorNodeConfigSchema = z$1.object({
	...
	solidColor: z$1.string().regex(/^#(?:[0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/, "must be a valid hex color starting with #").default("#3b82f6"),
	gradientStart: z$1.string().regex(/^#(?:[0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/, "must be a valid hex color starting with #").default("#3b82f6"),
	gradientEnd: z$1.string().regex(/^#(?:[0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/, "must be a valid hex color starting with #").default("#d8711dff"),
