		...
		if (node.type === "Compositor") {
			...
			const walkLayout = (nodes$1, nodePath) => {
				for (const [index, nodeConfig] of (nodes$1 ?? []).entries()) {
					...
					const config$1 = nodeConfig;
					if (config$1.kind === "media") {
