import { N as getActiveMediaMetadata, O as createOutputItemSchema, P as getFingerprint, a as TOKENS } from "./dist-CZ1kEBl4.mjs";
import { a as defineMetadata, i as defineNode } from "./server-B5otyLV2.mjs";
import { u as configBuilder } from "./dist-tM4GX3DS.mjs";
import { z as z$1 } from "zod";
import { inject, injectable } from "inversify";

//#region ../../nodes/node-extract-lut/dist/metadata-C3P2llPp.mjs
const extractLutConfig = configBuilder().field("strategy", z$1.enum(["deterministic", "statistical"]).default("deterministic"), {
	bindable: false,
	label: "Extraction Strategy"
}).field("samplePoints", z$1.number().min(10).max(500).default(150), {
	bindable: true,
