import { A as noop, C as isFunction, E as isObject, O as isString, S as isDate, T as isNumber, _ as freeze, b as isBoolean, f as SchemableIdentifierNode, h as IdentifierNode, k as isUndefined, m as ON_COMMIT_ACTIONS, n as CreateViewNode, p as CreateTableNode, s as RawNode, t as DefaultQueryCompiler, w as isNull, x as isBuffer, y as isBigInt } from "./default-query-compiler-BRWXYpwz.mjs";
import { A as SelectAllNode, C as ValueNode, D as parseStringReference, E as parseOrderedColumnName, M as isOperationNodeSource, O as logOnce, S as parseValueBinaryOperationOrExpression, T as parseColumnName, _ as OperationNodeTransformer, a as parseExpression, b as SelectQueryNode, c as CaseNode, d as QueryExecutorBase, f as printBackgroundFail, g as WithSchemaPlugin, h as Deferred, i as DynamicTableBuilder, j as ColumnNode, k as DynamicReferenceBuilder, l as createFunctionModule, m as provideControlledConnection, n as sql, o as parseDataTypeExpression, p as waitOrAbort, r as parseTable, s as CaseBuilder, t as CompiledQuery, u as QueryCreator, v as createQueryId, w as ValueListNode, x as QueryNode, y as randomString } from "./compiled-query-Bw_2JZUJ.mjs";
import { n as SqliteQueryCompiler, r as DialectAdapterBase, t as SqliteAdapter } from "./sqlite-adapter-DvqLTmyz.mjs";
import { S as logger } from "./tracer-paBLaQ7d.mjs";
import { n as createAdapterFactory } from "./adapter-BjHHVvWA.mjs";
...
const createKyselyAdapter = async (config) => {
	...
	if ("fileControl" in db) {
		const { BunSqliteDialect } = await import("./bun-sqlite-dialect-DTyyejk1-B9BetUXn.mjs");
	...
	if ("createSession" in db) {
		...
		if (DatabaseSync && db instanceof DatabaseSync) {
			const { NodeSqliteDialect } = await import("./node-sqlite-dialect-CglO0pXj.mjs");
			dialect = new NodeSqliteDialect({ database: db });
		}
	}
	if ("batch" in db && "exec" in db && "prepare" in db) {
		const { D1SqliteDialect } = await import("./d1-sqlite-dialect-CDCl_qH4-Dn7Jnd5s.mjs");
