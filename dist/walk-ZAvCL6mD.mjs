...
pp$5.parseSubscripts = function(base$1, startPos, startLoc, noCalls, forInit) {
	...
	while (true) {
		var element = this.parseSubscript(base$1, startPos, startLoc, noCalls, maybeAsyncArrow, optionalChained, forInit);
		if (element.optional) optionalChained = true;
		if (element === base$1 || element.type === "ArrowFunctionExpression") {
			if (optionalChained) {
...
function simple(node, visitors, baseVisitor, state, override) {
	...
	(function c(node$1, st, override$1) {
		var type = override$1 || node$1.type;
		visitNode(baseVisitor, type, node$1, st, c);
		if (visitors[type]) visitors[type](node$1, st);
	})(node, state, override);
}
function ancestor(node, visitors, baseVisitor, state, override) {
	...
	(function c(node$1, st, override$1) {
		...
		visitNode(baseVisitor, type, node$1, st, c);
		if (visitors[type]) visitors[type](node$1, st || ancestors, ancestors);
...
base.ImportDeclaration = function(node, st, c) {
	...
	c(node.source, st, "Expression");
	if (node.attributes) for (var i$1$1 = 0, list$1$1 = node.attributes; i$1$1 < list$1$1.length; i$1$1 += 1) {
		var attr = list$1$1[i$1$1];
		c(attr, st);
	}
};
...
//#endregion
export { simple as n, parse as r, ancestor as t };