import { D as checkNodeResultCache, O as createOutputItemSchema, a as TOKENS, b as MultiOutputGenericSchema, c as logger, w as VirtualMediaDataSchema, z as stampResult } from "./dist-CJI3Jl43.mjs";
import { a as defineMetadata, i as defineNode } from "./server-ClH_dFot.mjs";
import { z as z$1 } from "zod";
import { inject, injectable } from "inversify";

//#region ../../nodes/node-caption-generator/dist/metadata-DUNEwBWk.mjs
...
const CaptionGeneratorNodeConfigSchema = z$1.object({
	model: z$1.enum(CAPTION_GEN_MODELS),
	...
	batch_size: z$1.number().int().default(32)
}).strict();
