import { A as noop, C as isFunction, E as isObject, O as isString, S as isDate, T as isNumber, _ as freeze, b as isBoolean, f as SchemableIdentifierNode, h as IdentifierNode, k as isUndefined, m as ON_COMMIT_ACTIONS, n as CreateViewNode, p as CreateTableNode, s as RawNode, t as DefaultQueryCompiler, w as isNull, x as isBuffer, y as isBigInt } from "./default-query-compiler-BcDcZkmr.mjs";
import { A as SelectAllNode, C as ValueNode, D as parseStringReference, E as parseOrderedColumnName, M as isOperationNodeSource, O as logOnce, S as parseValueBinaryOperationOrExpression, T as parseColumnName, _ as OperationNodeTransformer, a as parseExpression, b as SelectQueryNode, c as CaseNode, d as QueryExecutorBase, f as printBackgroundFail, g as WithSchemaPlugin, h as Deferred, i as DynamicTableBuilder, j as ColumnNode, k as DynamicReferenceBuilder, l as createFunctionModule, m as provideControlledConnection, n as sql, o as parseDataTypeExpression, p as waitOrAbort, r as parseTable, s as CaseBuilder, t as CompiledQuery, u as QueryCreator, v as createQueryId, w as ValueListNode, x as QueryNode, y as randomString } from "./compiled-query-zCyBliro.mjs";
import { n as SqliteQueryCompiler, r as DialectAdapterBase, t as SqliteAdapter } from "./sqlite-adapter-DZUIkFl1.mjs";
import { S as logger } from "./tracer-CqAOZ_fk.mjs";
import { n as createAdapterFactory } from "./adapter-vjWUyav7.mjs";
...
const createKyselyAdapter = async (config) => {
	...
	if ("fileControl" in db) {
		const { BunSqliteDialect } = await import("./bun-sqlite-dialect-DTyyejk1-BW4cFBLq.mjs");
	...
	if ("createSession" in db) {
		...
		if (DatabaseSync && db instanceof DatabaseSync) {
			const { NodeSqliteDialect } = await import("./node-sqlite-dialect-CTogoONy.mjs");
			dialect = new NodeSqliteDialect({ database: db });
		}
	}
	if ("batch" in db && "exec" in db && "prepare" in db) {
		const { D1SqliteDialect } = await import("./d1-sqlite-dialect-CDCl_qH4-D1KNUsgb.mjs");
