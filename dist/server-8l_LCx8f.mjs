import "./dist-Cb5n7sba.mjs";
import "./dist-BJT_v1BL.mjs";
import { a as buildWGSLSignalFn } from "./dist-rfuvqZnV.mjs";
import { t as DataType } from "./dist-BtS_watq.mjs";
import { a as defineMetadata, i as defineNode } from "./server-CvuBrF2w.mjs";
import { o as SignalResultSchema } from "./dist-xdozats3.mjs";
import { z as z$1 } from "zod";
import { injectable } from "inversify";

//#region ../../nodes/node-signal/dist/metadata-DOqU-HxU.mjs
...
const SignalNodeConfigSchema = z$1.object({
	amplitude: z$1.number().min(0).default(1),
	frequency: z$1.number().min(0).default(1),
	phase: z$1.number().min(-2 * Math.PI).max(2 * Math.PI).default(0),
	offset: z$1.number().default(0),
	amplitudeMin: z$1.number().default(-1),
	amplitudeMax: z$1.number().default(1),
	spatialScale: z$1.number().min(0).default(1),
	spatialSpeed: z$1.number().default(1),
	fmAmplitude: z$1.number().min(0).default(1),
	fmFrequency: z$1.number().min(0).default(.5),
	gateEnabled: z$1.boolean().default(false),
	gateStartFrame: z$1.number().int().min(0).default(0),
	gateEndFrame: z$1.number().int().min(0).default(100),
	...
	envelopeCycles: z$1.number().int().min(1).default(2),
	...
	if (data.amplitudeMax <= data.amplitudeMin) ctx.addIssue({
		code: z$1.ZodIssueCode.custom,
		path: ["amplitudeMax"],
		message: "amplitudeMax must be greater than amplitudeMin"
	});
	if (data.gateEndFrame <= data.gateStartFrame) ctx.addIssue({
		code: z$1.ZodIssueCode.custom,
		path: ["gateEndFrame"],
