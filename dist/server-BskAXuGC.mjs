import { M as getActiveMediaMetadata, T as appendOperation, a as TOKENS } from "./dist-Cb5n7sba.mjs";
import { a as defineMetadata, i as defineNode } from "./server-CvuBrF2w.mjs";
import { c as VideoResultSchema, i as ImageResultSchema, l as configBuilder } from "./dist-xdozats3.mjs";
import { z as z$1 } from "zod";
import { inject, injectable } from "inversify";

//#region ../../nodes/node-colorkey/dist/metadata-31Tj91xZ.mjs
const colorKeyConfig = configBuilder().field("keyColor", z$1.string().regex(/^#(?:[0-9a-fA-F]{3}|[0-9a-fA-F]{4}|[0-9a-fA-F]{6}|[0-9a-fA-F]{8})$/, "must be a valid hex color starting with #").default("#00ff00"), {
	bindable: false,
	label: "Key Color"
