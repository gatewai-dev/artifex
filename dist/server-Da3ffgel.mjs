...
//#region ../../nodes/node-edit-video/dist/metadata-B98_hKgp.mjs
...
const WanEditConfigSchema = z$1.object({
	...
	wanAspectRatio: z$1.enum([...WAN_ASPECT_RATIOS, "original"]).default("original"),
	...
	wanSeed: z$1.number().int().min(0).max(2147483647).optional(),
	wanEnableSafetyChecker: z$1.boolean().default(false)
});
