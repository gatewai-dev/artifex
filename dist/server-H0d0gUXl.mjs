import { M as generateId, O as createOutputItemSchema, a as TOKENS, b as MultiOutputGenericSchema, c as logger, k as createVirtualMedia, s as getAssetKey, w as VirtualMediaDataSchema } from "./dist-D86uNdKf.mjs";
import { a as defineMetadata, i as defineNode } from "./server-BdNfjggX.mjs";
import { z as z$1 } from "zod";
import { inject, injectable } from "inversify";

//#region ../../nodes/node-svg/dist/metadata-BnrJ3QDs.mjs
...
const SvgNodeConfigSchema = z$1.object({
	model: z$1.enum(SVG_NODE_MODELS),
	...
	colors: z$1.array(z$1.string()).max(10).default([]),
	backgroundColor: z$1.string().nullable().default(null)
}).strict();
