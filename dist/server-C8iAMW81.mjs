import { x as NodeResultSchema } from "./dist-DdOALdQJ.mjs";
import { a as defineMetadata, i as defineNode, n as ServerPassthroughProcessor } from "./server-BLjQvdJL.mjs";
