...
//#region ../../nodes/node-extract-object/dist/metadata-Cxtfm7SM.mjs
const EXTRACT_OBJECT_MODELS = ["bria/extract-object"];
const ExtractObjectNodeConfigSchema = z$1.object({
	model: z$1.enum(EXTRACT_OBJECT_MODELS).catch("bria/extract-object"),
	autocrop: z$1.boolean().catch(false),
	remove_background: z$1.boolean().catch(false)
});
