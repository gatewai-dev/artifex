import { E as appendOperation, N as getActiveMediaMetadata, O as createOutputItemSchema, a as TOKENS, b as MultiOutputGenericSchema, k as createVirtualMedia, w as VirtualMediaDataSchema } from "./dist-vHBVmGr1.mjs";
import { a as defineMetadata, i as defineNode } from "./server-CREtBW5m.mjs";
import { z as z$1 } from "zod";
import { inject, injectable } from "inversify";

//#region ../../nodes/node-paint/dist/metadata-BO0c_kEq.mjs
const BrushStrokeSchema = z$1.object({
	id: z$1.string().min(1).default(() => Math.random().toString(36).substring(7)),
	tool: z$1.literal("brush"),
	path: z$1.string(),
	color: z$1.string().regex(/^#(?:[0-9a-fA-F]{8}|[0-9a-fA-F]{6}|[0-9a-fA-F]{3})$/, "must be a hex color"),
...
const PaintNodeConfigSchema = z$1.object({
	...
	backgroundColor: z$1.string().regex(/^#(?:[0-9a-fA-F]{8}|[0-9a-fA-F]{6}|[0-9a-fA-F]{3})$/, "must be a hex color").default("#ffffff"),
