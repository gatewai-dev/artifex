...
//#region ../../nodes/node-remove-background/dist/metadata-Bc5rhZAc.mjs
const RMBG_NODE_MODELS = [...["fal-ai/bria/background/remove"]];
const RemBgNodeConfigSchema = z$1.object({ model: z$1.enum(RMBG_NODE_MODELS).catch("fal-ai/bria/background/remove") });
