...
import { c as VideoResultSchema, i as ImageResultSchema, l as configBuilder } from "./dist-C-mYL7qe.mjs";
import { z as z$1 } from "zod";
import { inject, injectable } from "inversify";

//#region ../../nodes/node-colorkey/dist/metadata-CC9daguQ.mjs
const colorKeyConfig = configBuilder().field("keyColor", z$1.string().regex(/^#[0-9a-fA-F]{6}$/, "Must be a 6-digit hex color e.g. #00ff00").default("#00ff00"), {
	bindable: false,
	label: "Key Color"
