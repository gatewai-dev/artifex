import { k as createVirtualMedia } from "./dist-xnVPaj2K.mjs";
...
//#region ../../nodes/node-noise-generator/dist/metadata-QpxJLoiB.mjs
...
}).field("colorStart", z$1.string().default("#000000"), {
	bindable: false,
	label: "Color Start"
}).field("colorEnd", z$1.string().default("#ffffff"), {
	bindable: false,
	label: "Color End"
}).field("durationMs", z$1.number().min(0).default(5e3), {
	bindable: false,
	label: "Duration (ms)"
}).field("fps", z$1.number().min(1).max(120).default(30), {
	bindable: false,
	label: "FPS"
}).build();
