...
import {
	FADE_OUTPUT_TYPE_MAP,
	FadeNodeConfigSchema,
	type FadeResult,
} from "../shared/index.js";

@injectable()
export class FadeProcessor implements NodeProcessor {
	constructor(
	...
	async process({
		node,
		data,
	}: BackendNodeProcessorCtx): Promise<BackendNodeProcessorResult<FadeResult>> {
		try {
