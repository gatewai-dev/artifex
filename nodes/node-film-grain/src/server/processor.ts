...
import {
	FILM_GRAIN_OUTPUT_TYPE_MAP,
	FilmGrainNodeConfigSchema,
	type FilmGrainResult,
} from "../shared/index.js";

@injectable()
export class FilmGrainProcessor implements NodeProcessor {
	constructor(
	...
	async process({
		...
		BackendNodeProcessorResult<FilmGrainResult>
	> {
		try {
			...
			return {
				success: false,
				error:
					err instanceof Error ? err.message : "Film Grain processing failed",
			};
		}
	}
}
