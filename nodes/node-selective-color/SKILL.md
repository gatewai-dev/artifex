...
summary: >
  Photoshop-standard CMYK color grading tool. Adjusts Cyan, Magenta, Yellow, and Black inks across 9 targeted color ranges without edge artifacts or noisy pixel masks.
triggers:
  - selective color
  - cmyk color grading
  - color balance range
