...
import {
	PATCH_HEAL_OUTPUT_TYPE_MAP,
	PatchHealNodeConfigSchema,
	type PatchHealResult,
} from "../shared/index.js";

@injectable()
export class PatchHealProcessor implements NodeProcessor {
	constructor(
	...
	async process({
		...
		BackendNodeProcessorResult<PatchHealResult>
	> {
		try {
			...
			return {
				success: false,
				error:
					err instanceof Error ? err.message : "PatchHeal processing failed",
			};
		}
	}
}
