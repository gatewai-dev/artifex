...
nodeType: RefineEdge
summary: >
  Matte defringing and edge decontamination. Strips background color bleeding halos, refines edge transparency, and smoothes sub-pixel details for hair, fur, and keying composites.
triggers:
  - refine edge
  - defringe
