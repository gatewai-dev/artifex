...
import {
	HALFTONE_SCREEN_OUTPUT_TYPE_MAP,
	HalftoneScreenNodeConfigSchema,
	type HalftoneScreenResult,
} from "../shared/index.js";

@injectable()
export class HalftoneScreenProcessor implements NodeProcessor {
	constructor(
	...
	async process({
		...
		BackendNodeProcessorResult<HalftoneScreenResult>
	> {
		try {
			...
			} as unknown as HalftoneScreenResult;
			...
			return {
				...
				error:
					err instanceof Error
						? err.message
						: "HalftoneScreen processing failed",
			};
		}
	}
}
