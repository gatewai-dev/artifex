...
import {
	NOISE_GATE_OUTPUT_TYPE_MAP,
	NoiseGateNodeConfigSchema,
	type NoiseGateResult,
} from "../shared/index.js";

@injectable()
export class NoiseGateProcessor implements NodeProcessor {
	constructor(
	...
	async process({
		...
		BackendNodeProcessorResult<NoiseGateResult>
	> {
		try {
