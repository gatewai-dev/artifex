...
import {
	VIGNETTE_OUTPUT_TYPE_MAP,
	VignetteNodeConfigSchema,
	type VignetteResult,
} from "../shared/index.js";

@injectable()
export class VignetteProcessor implements NodeProcessor {
	constructor(
	...
	async process({
		...
		BackendNodeProcessorResult<VignetteResult>
	> {
		try {
			...
			return {
				success: false,
				error:
					err instanceof Error ? err.message : "Vignette processing failed",
			};
		}
	}
}
